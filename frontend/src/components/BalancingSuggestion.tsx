        ...
        <div className="flex flex-wrap items-end gap-4">
          <div className="space-y-1">
            ...
            <Input
              ...
              placeholder="e.g. 12"
              className="w-32 bg-slate-50 dark:bg-slate-700/50 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white"
            />
          </div>
          <div className="space-y-1">
            <Label className="text-slate-600 dark:text-slate-300 text-xs font-medium">
            ...
            <Input
              ...
              className="w-28 bg-slate-50 dark:bg-slate-700/50 border-slate-300 dark:border-slate-600 text-slate-900 dark:text-white"
            />
          </div>
          {cwSlot && (
        ...
        {(() => {
          ...
          return (
            <div className="rounded-lg border border-slate-200 dark:border-slate-700/50 overflow-hidden">
              ...
              {cwSlot && (
                <div className="border-t-2 border-amber-300 dark:border-amber-700 bg-amber-50 dark:bg-amber-900/10 px-4 py-2.5 flex items-center gap-4 text-xs">
