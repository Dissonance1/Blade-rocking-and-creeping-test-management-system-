...
export default function AssemblyVerificationPage() {
  ...
  return (
    <>
    <div className="min-h-screen bg-slate-100 dark:bg-slate-900 text-slate-900 dark:text-white flex flex-col">
      {/* Header */}
      <div className="border-b border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-800/40 px-6 py-4 shadow-sm shrink-0">
        <div className="max-w-screen-xl mx-auto flex flex-wrap items-center gap-4">
          <Button
            variant="ghost"
            size="sm"
            onClick={() => navigate("/assembly-queue")}
            className="text-slate-500 hover:text-slate-800 dark:hover:text-white -ml-2"
          >
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-3 mt-1">
              ...
              <div className="flex-1 min-w-[120px] max-w-[200px] bg-slate-200 dark:bg-slate-700 rounded-full h-1.5">
                <div
      ...
      {/* Body */}
      <div className="flex-1 max-w-screen-xl mx-auto w-full px-6 py-6 flex gap-6 min-h-0">
        {/* ── Left: blade list ── */}
        ...
        <div className="flex-1 min-w-0">
          {!selectedBlade ? (
            <div className="h-full flex flex-col items-center justify-center text-slate-400 dark:text-slate-500">
              ...
              <p className="font-medium text-lg">Select a blade from the list to verify</p>
            ...
            <div className="space-y-4">
              ...
              {selectedBlade.status === "ASSEMBLY_RECEIVED" && decision !== "result" && (
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                  ...
                  {/* ── DTI readings ── */}
                  <Card className="bg-white dark:bg-slate-800/60 border-slate-200 dark:border-slate-700/60 lg:col-span-2">
                    <CardContent className="p-4">
